...
import { matchesMonitorSegment } from '@/lib/catalogSegments';

const ITEMS_PER_PAGE = 24;

const TABS = [
  { id: 'all', label: 'Tüm Monitörler', desc: 'Tüm boyut ve yenileme hızları' },
  { id: 'gaming', label: 'Oyuncu Monitörleri (144Hz+)', desc: 'Yenileme hızı 144 Hz ve üzeri modeller' },
  { id: 'pro', label: 'Grafik & 4K/UHD', desc: '4K çözünürlük veya profesyonel ürün serileri' },
  { id: '27inch', label: '27-28 İnç', desc: 'İdeal çalışma ve oyun boyutu' },
  { id: '32inch', label: '31 İnç ve Üzeri', desc: 'Büyük ekran ve kavisli (curved) deneyim' },
  { id: '24inch', label: '23-25 İnç', desc: 'Kompakt masaüstü ve espor' }
];
  ...
  const displayProducts = useMemo(() => {
    return products
      .filter((p) => {
        ...
        return matchesMonitorSegment(p, activeTab);
      })
