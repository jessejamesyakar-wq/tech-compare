...
import { DigitalLedBillboardScreen } from '@/components/ads/DigitalLedBillboardScreen';
...
export default function HomePage() {
  ...
  return (
    <div className="space-y-8 py-2">
      ...
      {/* 🏢 Dijital LED Billboard Ekranı (MediaMarkt) & Pengi Maskotu */}
      <DigitalLedBillboardScreen />
