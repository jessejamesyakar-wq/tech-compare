        ...
        <div className="lg:col-span-5 flex flex-col items-center justify-center relative">
          <Link href={targetHref} className="group/card w-full block cursor-pointer">
            <div className="w-full bg-white/90 backdrop-blur-xl rounded-[28px] p-6 shadow-xl hover:shadow-2xl transition-all duration-500 text-center flex flex-col items-center border border-white/90 relative overflow-hidden">
              ...
              {/* Model Name & 3-Pill Hardware Specs */}
              <div className="mt-4 text-center w-full px-2 space-y-2">
                ...
                <div className="flex items-center justify-center gap-1.5 flex-wrap pt-1">
                  <span className="bg-slate-100/90 text-slate-700 border border-slate-200/80 text-[10px] font-extrabold px-2.5 py-0.5 rounded-lg shadow-2xs">
                    📱 120Hz LTPO Panel
                  </span>
                  <span className="bg-slate-100/90 text-slate-700 border border-slate-200/80 text-[10px] font-extrabold px-2.5 py-0.5 rounded-lg shadow-2xs">
                    ⚡ 3nm NPU Çip
                  </span>
                  <span className="bg-emerald-50 text-emerald-800 border border-emerald-200 text-[10px] font-extrabold px-2.5 py-0.5 rounded-lg shadow-2xs">
                    🎥 4K Pro Video
                  </span>
                </div>
              </div>
