            ...
            return (
              ...
              >
                <div>
                  ...
                  {/* Product Image Box */}
                  <Link href={href} className="block relative mb-3 flex justify-center">
                    <ProductImage
                      src={product.image}
                      alt={product.name}
                      variant="card"
                      className="group-hover:scale-105 transition-transform duration-300 ease-out drop-shadow-sm"
                    />
                  </Link>
