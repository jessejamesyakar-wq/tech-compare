...
export const mockAppliances: ApplianceProduct[] = [
  // ==================== ROBOT SÜPÜRGELER ====================
  {
    ...
    priceHistory: [
      { date: 'Ekim 2025', price: 46999, store: 'Roborock TR' },
      { date: 'Aralık 2025', price: 44999, store: 'Hepsiburada' },
      { date: 'Şubat 2026', price: 43499, store: 'Trendyol' },
      { date: 'Mart 2026', price: 42999, store: 'Vatan Bilgisayar' }
    ],
    specs: {
      subCategory: 'robot_vacuum',
  ...
  },
  {
    ...
    name: 'Roborock Q Revo MaxV Akıllı Robot Süpürge',
    brand: 'Roborock',
    category: 'appliances',
    subCategory: 'robot_vacuum',
    basePrice: 37999,
    ...
    isFeatured: false,
    highlights: [
      '7000 Pa Aşırı Güçlü Emiş & FlexiArm Kenar Temizleme Paspası',
      '60°C Sıcak Suyla Paspas Yıkama & Sıcak Hava Kurutma',
      '"Hello Rocky" Dahili Sesli Asistan & Yapay Zekâ Kamera',
    ...
    priceHistory: [
      { date: 'Ekim 2025', price: 41999, store: 'Roborock TR' },
      { date: 'Aralık 2025', price: 39499, store: 'Hepsiburada' },
      { date: 'Şubat 2026', price: 38499, store: 'Trendyol' },
      { date: 'Mart 2026', price: 37999, store: 'Vatan Bilgisayar' }
    ],
    specs: {
      subCategory: 'robot_vacuum',
      subCategoryLabel: 'Robot Süpürge',
      ...
      batteryRuntimeMin: 180,
      noiseLevelDb: 63,
      capacity: '330 ml toz haznesi, 5 L temiz su',
      autoCleanDock: true,
      appControl: true,
      programsCount: 6,
      weightKg: 4.2,
